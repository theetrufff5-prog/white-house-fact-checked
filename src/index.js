...
const INVESTIGATOR_STYLES = `<style>
  .investigator-guide{position:fixed;right:18px;bottom:10px;z-index:30;font-family:Arial,sans-serif}.investigator-summon{display:flex;flex-direction:column;align-items:center;width:126px;padding:0 5px 9px;background:transparent;border:0;color:#fff;cursor:pointer;filter:drop-shadow(0 8px 18px #000b)}.investigator-summon img{display:block;width:66px;height:121px;object-fit:contain;transition:transform .25s}.investigator-summon span{margin-top:-3px;padding:7px 8px;background:#0d0f12ed;border:1px solid #77a9ff;color:#dce9ff;font:800 8px var(--font-geist-mono),monospace;letter-spacing:.07em;white-space:nowrap}.investigator-summon:hover img,.investigator-summon:focus-visible img{transform:translateY(-5px)}.investigator-summon:focus-visible{outline:2px solid #77a9ff;outline-offset:3px}.investigator-panel{position:absolute;right:0;bottom:8px;width:min(440px,calc(100vw - 24px));padding:24px 28px 27px;background:#090b0ef7;border:1px solid #545860;border-left:4px solid #f0443e;box-shadow:0 22px 65px #000e;backdrop-filter:blur(14px);color:#f5f5f3}.investigator-panel[hidden]{display:none}.investigator-guide.is-open .investigator-summon{visibility:hidden}.investigator-close{position:absolute;right:11px;top:7px;z-index:1;padding:2px 8px;background:none;border:0;color:#aeb1b8;font-size:28px;cursor:pointer}.investigator-panel header{display:grid;grid-template-columns:76px 1fr;align-items:center;gap:14px;margin:-14px 24px 15px -5px}.investigator-panel header img{display:block;width:76px;height:139px;object-fit:contain;filter:drop-shadow(0 7px 12px #000c)}.investigator-panel header p{margin:0 0 8px;color:#77a9ff;font:800 9px var(--font-geist-mono),monospace;letter-spacing:.1em}.investigator-panel h2{margin:0;font-size:27px;line-height:.95;text-transform:uppercase}.investigator-panel form label{display:block;margin-bottom:8px;color:#aeb1b8;font:700 9px var(--font-geist-mono),monospace;text-transform:uppercase}.investigator-panel form>div{display:flex}.investigator-panel input{min-width:0;flex:1;padding:13px;background:#030405;border:1px solid #444851;color:#fff;font-size:15px}.investigator-panel form button{padding:0 14px;background:#b20f18;border:0;color:#fff;font:800 10px var(--font-geist-mono),monospace;cursor:pointer}.investigator-results{max-height:245px;overflow:auto;margin-top:18px}.investigator-results>p{color:#aeb1b8;line-height:1.5}.investigator-results>a{display:block;padding:13px 0;border-top:1px solid #34373e;color:#fff;text-decoration:none}.investigator-results>a:hover b{color:#77a9ff}.investigator-results b,.investigator-results span,.investigator-results small{display:block}.investigator-results b{text-transform:uppercase}.investigator-results span{margin:4px 0;color:#f0443e;font:700 8px var(--font-geist-mono),monospace;letter-spacing:.07em;text-transform:uppercase}.investigator-results small,.investigator-panel>small{color:#898d94;line-height:1.45}.investigator-panel>small{display:block;margin-top:15px}@media(max-width:600px){.investigator-guide{right:8px;bottom:5px}.investigator-summon{width:96px}.investigator-summon img{width:54px;height:99px}.investigator-summon span{font-size:7px}.investigator-panel{right:3px;bottom:3px;padding:22px}.investigator-panel form>div{display:grid}.investigator-panel form button{padding:12px}}@media(prefers-reduced-motion:reduce){.investigator-summon img{transition:none}}
</style>`;
...
async function serveSiteAsset(request, env) {
  ...
  const interactiveHtml = html.replace(
    "</head>",
    `${ENERGY_VIDEO_STYLES}${EDITORIAL_TEAM_STYLES}${PARANORMAL_PROMO_STYLES}${COMMENTS_STYLES}${INVESTIGATOR_STYLES}<script src="/energy-video.js" defer></script><script src="/usps-story.js" defer></script><script src="/editorial-team.js" defer></script><script src="/paranormal-promo.js" defer></script><script src="/community-comments.js" defer></script><script src="/investigator-guide.js" defer></script><script src="https://challenges.cloudflare.com/turnstile/v0/api.js" async defer></script></head>`,
